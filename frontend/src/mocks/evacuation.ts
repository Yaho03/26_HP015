...
export const MOCK_ROUTE_DEGRADED: EvacuationRouteMessage = {
  ...
  waypoints: [
    { seq: 0, nav_node_id: null, x_m: 54.0, y_m: 0.8, z_m: 0.0, level_id: "L0", edge_kind_to_next: "walk", label: "현재 위치" },
    { seq: 1, nav_node_id: "nav.floor.aft", x_m: 56.0, y_m: 0.0, z_m: 0.0, level_id: "L0", edge_kind_to_next: "walk", label: "선미 바닥" },
    { seq: 2, nav_node_id: "nav.floor.stbd", x_m: 30.0, y_m: 5.0, z_m: 0.0, level_id: "L0", edge_kind_to_next: "walk", label: "우현 우회로" },
    { seq: 3, nav_node_id: "nav.floor.fwd", x_m: 4.0, y_m: 0.0, z_m: 0.0, level_id: "L0", edge_kind_to_next: "walk", label: "선수 바닥" },
    { seq: 4, nav_node_id: "nav.ladder.fwd.bottom", x_m: 2.0, y_m: 0.0, z_m: 0.0, level_id: "L0", edge_kind_to_next: "ladder", label: "전방 트렁크 하단" },
    { seq: 5, nav_node_id: "nav.exit.trunk-fwd", x_m: 2.0, y_m: 0.0, z_m: 14.0, level_id: "L1", edge_kind_to_next: null, label: "전방 접근 트렁크" },
  ],
...
export const MOCK_ROUTE_NO_SAFE: EvacuationRouteMessage = {
  ...
  waypoints: [
    { seq: 0, nav_node_id: null, x_m: 30.2, y_m: 0.45, z_m: 0.0, level_id: "L0", edge_kind_to_next: "walk", label: "현재 위치" },
    { seq: 1, nav_node_id: "nav.floor.mid", x_m: 30.0, y_m: 0.0, z_m: 0.0, level_id: "L0", edge_kind_to_next: "walk", label: "중앙 통로" },
    { seq: 2, nav_node_id: "nav.floor.fwd", x_m: 4.0, y_m: 0.0, z_m: 0.0, level_id: "L0", edge_kind_to_next: "walk", label: "선수 바닥" },
    { seq: 3, nav_node_id: "nav.ladder.fwd.bottom", x_m: 2.0, y_m: 0.0, z_m: 0.0, level_id: "L0", edge_kind_to_next: "ladder", label: "전방 트렁크 하단" },
    { seq: 4, nav_node_id: "nav.exit.trunk-fwd", x_m: 2.0, y_m: 0.0, z_m: 14.0, level_id: "L1", edge_kind_to_next: null, label: "전방 접근 트렁크" },
